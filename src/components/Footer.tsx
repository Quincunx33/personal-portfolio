  ...
  return (
    <footer className="py-6 text-center font-mono text-sm text-slate-500 flex flex-col items-center gap-4">
      <div className="flex gap-6 md:hidden text-slate-400 mb-2">
        <a href="https://taissu.pages.dev/" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-500 transition-colors" aria-label="Portfolio"><Globe size={20} /></a>
      ...
      <p className="text-emerald-500/80 font-bold tracking-widest uppercase animate-pulse mb-2">
        All Glory to the Queen 👑
      </p>
      <p className="hover:text-emerald-500 transition-colors cursor-pointer">
        Governed by Tasfiya Tabassum // Sovereign of Dumbland
      </p>
    </footer>
  );
}
